...
import { DetalleConOrden, Agencia, formatearMonto } from '../../models/liquidaciones-presupuesto.models';

@Component({
  selector: 'app-modal-comprobante-ti',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './modal-comprobante.component.html',
})
export class ModalComprobanteComponentti implements OnInit {
