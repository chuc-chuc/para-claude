...
export class LiquidacionesPresupuestoService {
    ...
    cargarLiquidaciones(): Observable<boolean> {
        ...
        return this.api.query({
            ruta: 'contabilidad/obtenerLiquidacionesPorPlanNN',
            tipo: 'post',
            body: {area: 78}
        }).pipe(
    ...
    verificarDetalle(detalleId: number): Observable<boolean> {
        ...
        return this.api.query({
            ruta: 'contabilidad/verificarDetalleUnitarioPorPlanNN',
            tipo: 'post',
            body: payload
        }).pipe(
    ...
    verificarDetallesMasivo(detallesIds: number[]): Observable<boolean> {
        ...
        return this.api.query({
            ruta: 'contabilidad/verificarDetalleMasivoPorPlanNN',
            tipo: 'post',
            body: payload
        }).pipe(
            map((response: ApiResponse) => {
    ...
    asignarComprobante(detalleId: number, datos: AsignarComprobantePayload): Observable<boolean> {
        ...
        return this.api.query({
            ruta: 'contabilidad/asignarComprobanteUnitarioPorPlanNN',
            tipo: 'post',
            body: payload
        }).pipe(
            map((response: ApiResponse) => {
    ...
    asignarComprobanteMasivo(detallesIds: number[], datos: AsignarComprobanteMasivoPayload): Observable<boolean> {
        ...
        return this.api.query({
            ruta: 'contabilidad/asignarComprobanteMasivoPorPlanNN',
            tipo: 'post',
            body: payload
        }).pipe(
            map((response: ApiResponse) => {
    ...
    crearCambioSolicitado(detalle: DetalleLiquidacion, descripcionCambio: string): Observable<boolean> {
        ...
        return this.api.query({
            ruta: 'contabilidad/crearCambioSolicitadoPorPlanNN',
            tipo: 'post',
            body: payload
        }).pipe(
            map((response: ApiResponse) => {
    ...
    obtenerCambiosDetalle(detalleId: number): Observable<CambioSolicitado[]> {
        return this.api.query({
            ruta: 'contabilidad/obtenerCambiosSolicitadosPorDetallePlanNN',
            tipo: 'post',
