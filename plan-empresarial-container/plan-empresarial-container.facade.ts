...
export class PlanEmpresarialContainerFacade {
    ...
    private readonly _ordenesBaseCooldownMs = 1000; // 1s para evitar ráfagas
    ...
    private fetchOrdenesBase$(): Observable<any> {
        ...
        // Si ya hay una llamada en curso, o el resultado está "caliente", reúsalo
        if (this._ordenesBaseInFlight$ && stillWarm) {
            return this._ordenesBaseInFlight$;
        }

        // Nueva llamada (se compartirá con shareReplay)
