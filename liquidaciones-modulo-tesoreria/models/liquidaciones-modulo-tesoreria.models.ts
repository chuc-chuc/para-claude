...
/**
 * Payload para editar solicitud rechazada o pendiente
 */
...
export class ValidadoresLiquidacion {
    ...
    static puedeEditarSolicitud(solicitud: SolicitudTransferencia | null): boolean {
        return solicitud?.estado === 'rechazado' || solicitud?.estado === 'pendiente_aprobacion';
    }
    ...
    /**
     * Valida si puede editar comprobante
     */
    static puedeEditarComprobante(solicitud: SolicitudTransferencia | null): boolean {
