// detalle-liquidaciones-plan-empresarial/components/pago-forms/pago-cheque-form/pago-cheque-form.component.ts
...
export class PagoChequeFormComponent implements OnInit, OnDestroy {
  ...
  get infoFormulario() {
    return {
      ...
      descripcion: 'Complete la información del cheque que se utilizará para realizar el pago',
      icono: 'cheque',
      color: 'green'
    };
  }
  ...
  get estadoFormulario() {
    ...
    return {
      progreso: Math.round((camposCompletos / totalCampos) * 100),
      camposCompletos,
      totalCampos,
      esValido: this.form.valid
    };
  }
}